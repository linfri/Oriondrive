...
#* @apiDescription As of now, a very basic and Hello World-like API. The only endpoint within the API so far serves a WAV file with generated "amusing feedback" phrase completed by the DeepAI GPT2 model.
